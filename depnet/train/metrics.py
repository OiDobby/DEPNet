...
from hashlib import sha1  ### additional import
from typing import Union, Sequence, Tuple

import yaml  ### additional import
...
class Metrics:
    ...
    def __init__(
        ...
        self.running_stats = {}
        #self.per_species = {}  ### delete code line
        self.params = {}  ### additional code line
        self.funcs = {}
        self.kwargs = {}
        for component in components:
            ...
            #functional = params.pop("functional", "L1Loss")  ### delete code line
            functional = params.get("functional", "L1Loss")  ### additional code line
            ...
            #per_species = params.pop("PerSpecies", False)  ### delete code line

            if key not in self.running_stats:
                self.running_stats[key] = {}
                #self.per_species[key] = {}  ### delete code line
                #self.funcs[key] = find_loss_function(functional, {})  ### delete code line
                self.kwargs[key] = {}
                self.params[key] = {}
            ...
            #self.per_species[key][reduction] = per_species  ### delete code line
